...
var Driftwood = new function() {
  ...
  this.exception = function(exception,a,b) {
  	alert('hi');
  }  

  //Convience methods around the logger to have a static instance
  this.debug = function(message, obj) {
  	default_logger.debug(message,obj);
  };
  this.info = function(message, obj) {
  	default_logger.info(message,obj);
  };
  this.error = function(message, obj) {
  	default_logger.error(message,obj);
  };
...
window.exception = function(message, url, line) {
